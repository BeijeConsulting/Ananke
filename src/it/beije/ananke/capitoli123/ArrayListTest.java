...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(list4.equals(list3) + "\n"
				+ list3.remove(2) + " � l'elemento eliminato\n"
				+ list4.set(1, "maledizione") + " � l'elemento sostituito, per� "
				+ list4.get(1) + " � l'elemento che ho messo in lista");
		...
		System.out.println(list5.get(0) + " � un elemento inizializzato");
//		int j = list5.get(0);
//		System.out.println(j);
		...
		try {
			...
			i = 0;
			System.out.println(e.getMessage() + " i � stato inizializzato a 0");
		} finally {
