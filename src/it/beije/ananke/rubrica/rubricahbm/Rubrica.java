package it.beije.ananke.rubrica.rubricahbm;
...
public class Rubrica {
    ...
    public void importFromDB() {
        this.contacts = HBManager.selectAll();
    }
    ...
    public Contact getContact(Scanner scanner) {
        ...
        contactsFound = HBManager.selectByField("id", scanner.nextLine());
